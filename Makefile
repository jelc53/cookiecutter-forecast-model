SHELL := /bin/bash
.PHONY: help version bump setup docs lint test data_processing forecast_model optimisation
...
optimisation:	## run the optimisation pipeline
	. venv/bin/activate \
		&& python ce_core/run.py
